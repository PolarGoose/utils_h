...
public:
  watchdog(std::chrono::steady_clock::duration timeout, std::function<void()> on_triggered)
      : _on_triggered{std::move(on_triggered)}, _timeout{timeout}, _timer{std::in_place, _timeout, _on_triggered} {}
