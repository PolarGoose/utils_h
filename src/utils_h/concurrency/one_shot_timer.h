...
public:
  one_shot_timer(const std::chrono::steady_clock::duration time, std::function<void()> callback)
      : _time{time}, _callback{std::move(callback)}, _thread{&one_shot_timer::thread, this} {}
